...
public class MySQL extends HostnameDatabase
{
    ...
    protected boolean initialize()
    {
        try {
            ...
            warning("MySQL DataSource class missing: {0}", e.getMessage());
        }
    ...
    public boolean open()
    {
        try {
            ...
            error("Could not establish a MySQL connection, SQLException: {0}", e.getMessage());
        }
    ...
    public boolean isTable(String table)
    {
        ...
        try {
            ...
            error("Could not create a statement in checkTable(), SQLException: {0}", e.getMessage());
    ...
    public boolean truncate(String table)
    {
        try {
            ...
            error("Could not wipe table, SQLException: {0}", e.getMessage());
        }
